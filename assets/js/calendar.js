...
function parseICalMeta() {
  calendars.forEach(function(calendar) {
    calendar.color = calendar.color || calendar.ical.getFirstPropertyValue('x-apple-calendar-color');
    calendar.name = calendar.name || calendar.ical.getFirstPropertyValue('x-wr-calname').replace(/ \([0-9a-fA-F-]{36}\)/, '');
